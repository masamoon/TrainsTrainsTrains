...
const OUT_NAME := "map3_tight_overtake_pass_solution.png"
...
func _initialize() -> void:
	...
	_add_directional_lane_signals(main)
...
func _build_passing_siding_layout(main: Node) -> void:
	...
	main._place_track_path(Vector2i(1, 4), Vector2i(2, 4))
	main._place_track_path(Vector2i(2, 4), Vector2i(4, 4))
...
func _add_directional_lane_signals(main: Node) -> void:
	...
	var east_or_northwest: Array[Vector2i] = [Vector2i.RIGHT, Vector2i(-1, -1)]
	var east_or_west: Array[Vector2i] = [Vector2i.RIGHT, Vector2i.LEFT]
	var station_west: Array[Vector2i] = [Vector2i(1, 1)]
	var station_central: Array[Vector2i] = [Vector2i.RIGHT, Vector2i(-1, -1)]
	var station_east: Array[Vector2i] = [Vector2i(-1, -1)]

	main._replace_signal_set(Vector2i(1, 4), "chain", station_west)
	main._replace_signal_set(Vector2i(2, 4), "block", west)
	main._replace_signal_set(Vector2i(3, 5), "chain", east_or_west)
	main._replace_signal_set(Vector2i(8, 5), "chain", east_or_northwest)
	main._replace_signal_set(Vector2i(7, 4), "block", west)
	main._replace_signal_set(Vector2i(4, 4), "block", west)
	main._replace_signal_set(Vector2i(8, 4), "block", west)

	main._replace_signal_set(Vector2i(9, 5), "chain", station_central)
	main._replace_signal_set(Vector2i(11, 5), "chain", east_or_west)
	main._replace_signal_set(Vector2i(15, 5), "chain", east_or_northwest)
	main._replace_signal_set(Vector2i(14, 4), "block", west)
	main._replace_signal_set(Vector2i(12, 4), "block", west)
	main._replace_signal_set(Vector2i(10, 4), "block", southwest)
	main._replace_signal_set(Vector2i(15, 4), "block", west)
	main._replace_signal_set(Vector2i(16, 5), "chain", station_east)
	main._compute_blocks()
